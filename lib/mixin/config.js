...
module.exports = {
  getConfig (dir) {
    ...
    return Object.assign({}, util.loadFile(path.join(configDir, 'default.js')) || {}, util.loadFile(path.join(configDir, `${this.env}.js`)) || {}, util.loadFile(path.join(configDir, '.local.js')) || {})
  },
