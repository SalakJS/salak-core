...
module.exports = (options, app) => {
  let { level, category, ignoreHeaderKeys } = Object.assign({}, defaults, options)
  ...
  return async (ctx, next) => {
    ...
    // 解析request
    meta.req = parseRequest(ctx.request, ignoreHeaderKeys)
...
function parseRequest (request, ignoreHeaderKeys) {
  const headers = {}
